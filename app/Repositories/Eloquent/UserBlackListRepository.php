...
use App\Repositories\Contracts\UserBlackListRepositoryInterface;
use App\Services\AutoFIlterAndSortService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Arr;

class UserBlackListRepository implements UserBlackListRepositoryInterface
{
    public function __construct(
        private readonly UserBlackList $model,
    ) {}

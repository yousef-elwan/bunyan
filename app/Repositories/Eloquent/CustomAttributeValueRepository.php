...
use App\Repositories\Contracts\CustomAttributeValueRepositoryInterface;
use App\Services\AutoFIlterAndSortService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Arr;

class CustomAttributeValueRepository implements CustomAttributeValueRepositoryInterface
{
    public function __construct(
        private readonly CustomAttributeValue $model,
    ) {}

...
use App\Models\UserPrivateComment;
use App\Repositories\Contracts\UserPrivateCommentRepositoryInterface;
use App\Services\AutoFIlterAndSortService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Arr;

class UserPrivateCommentRepository implements UserPrivateCommentRepositoryInterface
{
    public function __construct(
        private readonly UserPrivateComment $model,
    ) {}

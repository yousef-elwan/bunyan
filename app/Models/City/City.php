 ...
 * @package App\Models
 */
class City extends GeneralModel
{
    ...
    public function imageUrl(): Attribute
    {
        ...
        $value = !is_null($image) ?  asset('/' . CITY_IMAGE_NAME . '/' . $image) :
            config('app.web_config.default_city_image');
    ...
    {
        return $this->hasMany(CityTranslation::class, foreignKey: 'city_id', localKey: 'id');
    }
    ...
    /**
     * Get the defaultTranslation associated with the City
     *

 ...
 * @package App\Models
 */
class Orientation extends GeneralModel
{
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'orientations_translations';
    }
    ...
    {
        return $this->hasMany(OrientationTranslation::class, foreignKey: 'orientation_id', localKey: 'id');
    }
    ...
    {
        return $this->hasOne(OrientationTranslation::class, 'orientation_id')

 ...
 * @package App\Models
 */
class CustomAttribute extends GeneralModel
{
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'attributes_translations';
    }
    ...
    /**
     * Get all of the translations for the CustomAttributes
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function translations(): HasMany
    {
        return $this->hasMany(CustomAttributeTranslation::class, foreignKey: 'attribute_id', localKey: 'id');
    }
    ...
    {
        return $this->hasMany(CustomAttributeValue::class, foreignKey: 'attribute_id', localKey: 'id');
    }

    /**
     * Get the defaultTranslation associated with the CustomAttributes
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function defaultTranslation(): HasOne
    {
        return $this->hasOne(CustomAttributeTranslation::class, 'attribute_id')

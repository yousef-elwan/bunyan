 ...
 * @package App\Models
 */
class ReportStatus extends GeneralModel
{
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'report_status_translations';
    }
    ...
    {
        return $this->hasMany(ReportStatusTranslation::class, foreignKey: 'report_status_id', localKey: 'id');
    }

    /**
     * Get the defaultTranslation associated with the ReportStatus
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function defaultTranslation(): HasOne
    {
        return $this->hasOne(ReportStatusTranslation::class, 'report_status_id')

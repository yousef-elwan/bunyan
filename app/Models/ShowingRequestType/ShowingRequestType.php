 ...
 * @package App\Models
 */
class ShowingRequestType extends GeneralModel 
{

    /**
     * Table Name In Database.
     */
    protected $table = "showing_request_types";
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'showing_request_type_translations';
    }
    ...
    public function getTranslationForeignKey(): ?string
    {
        ...
        return 'showing_request_type_id';
    }
    ...
    {
        return $this->hasMany(ShowingRequestTypeTranslation::class, foreignKey: 'showing_request_type_id', localKey: 'id');
    }

    /**
     * Get the defaultTranslation associated with the floor
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function defaultTranslation(): HasOne
    {
        return $this->hasOne(ShowingRequestTypeTranslation::class, 'showing_request_type_id')

 ...
 * @package App\Models
 */
class Amenity extends GeneralModel
{
    ...
    /**
     * Get all of the translations for the Amenity
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function translations(): HasMany
    {
        return $this->hasMany(AmenityTranslation::class, foreignKey: 'amenity_id', localKey: 'id');
    }

    /**
     * Get the defaultTranslation associated with the Amenity
     *
    ...
    public function imageUrl(): Attribute
    {
        $image = $this->image;
        return new Attribute(
            get: fn() =>  isset($image) ?  Storage::disk('public')->url(CATEGORY_IMAGE_NAME . "/" . $image) : null,
        );
    }

 ...
 *
 * @type int $id Primary
 * @type \Carbon\Carbon $created_at
 * @type int $created_by
 * @type \Carbon\Carbon $updated_at
 * @type int $updated_by
 *
 * @package App\Models
 */
class Type extends GeneralModel
{
    ...
    {
        return $this->hasMany(TypeTranslation::class, foreignKey: 'type_id', localKey: 'id');
    }
    ...
    {
        return $this->hasOne(TypeTranslation::class, 'type_id')

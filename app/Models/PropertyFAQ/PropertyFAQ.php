 ...
 * @package App\Models
 */
class PropertyFAQ extends GeneralModel
{
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'property_faq_translations';
    }
    ...
    {
        return $this->hasMany(PropertyFAQTranslation::class, foreignKey: 'property_faq_id', localKey: 'id');
    }
    ...
    {
        return $this->hasOne(PropertyFAQTranslation::class, 'property_faq_id')

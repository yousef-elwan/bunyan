 ...
 * @package App\Models
 */
class ContractType extends GeneralModel
{
    /**
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'contract_types_translations';
    }
    ...
    {
        return $this->hasMany(ContractTypeTranslation::class, foreignKey: 'contract_type_id', localKey: 'id');
    }
    ...
    {
        return $this->hasOne(ContractTypeTranslation::class, 'contract_type_id')

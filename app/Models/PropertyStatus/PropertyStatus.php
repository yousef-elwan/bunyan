 ...
 * @package App\Models
 */
class PropertyStatus extends GeneralModel
{
    ...
    public function getTranslationTable(): ?string
    {
        ...
        return 'property_status_translations';
    }
    ...
    {
        return $this->hasMany(PropertyStatusTranslation::class, foreignKey: 'status_id', localKey: 'id');
    }
    ...
    {
        return $this->hasOne(PropertyStatusTranslation::class, 'status_id')

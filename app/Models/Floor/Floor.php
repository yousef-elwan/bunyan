 ...
 * @package App\Models
 */
class Floor extends GeneralModel 
{
    ...
    {
        return $this->hasMany(FloorTranslation::class, foreignKey: 'floor_id', localKey: 'id');
    }
    ...
    {
        return $this->hasOne(FloorTranslation::class, 'floor_id')

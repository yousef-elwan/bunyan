...
{{-- =================================================================== --}}
{{-- ========== مودال المصادقة الرئيسي ========== --}}
{{-- =================================================================== --}}
<div class="auth-dialog-overlay" id="authDialogOverlay">
    <div class="auth-dialog-content">
                ...
                <div class="form-wrapper login-form active-form">
                    ...
                    <form id="loginForm" action="{{ route('auth.login.submit') }}" method="POST" novalidate>
                        ...
                        <div class="input-group">
                            ...
                            <span class="mt-1 text-sm text-danger invalid-feedback"
                                data-field="login_identifier"></span>
                        </div>
                        <div class="input-group">
                            <div class="relative">
                            ...
                            <span class="mt-1 text-sm text-danger invalid-feedback" data-field="password"></span>
                        </div>
                        <a href="#"
                    ...
                    <form id="registerForm" action="{{ route('auth.register.submit') }}" method="POST" novalidate>
                        ...
                        <div class="input-group-row">
                            <div class="input-group">
                                ...
                                <span class="mt-1 text-sm text-danger invalid-feedback" data-field="first_name"></span>
                            </div>
                            <div class="input-group">
                                <div class="relative">
                                    <i class="fas fa-user icon"></i>
                                ...
                                <span class="mt-1 text-sm text-danger invalid-feedback" data-field="last_name"></span>
                            </div>
                        </div>
                        <div class="input-group">
                            <div class="relative">
                                ...
                                <input type="email" name="email"
                                    placeholder="{{ __('app/auth_modal.email_placeholder', [], $currentLocale) }}"
                                    required
                                    aria-label="{{ __('app/auth_modal.email_placeholder', [], $currentLocale) }}">
                            </div>
                            <span class="mt-1 text-sm text-danger invalid-feedback" data-field="email"></span>
                        </div>
                        <div class="input-group">
                            ...
                            <span class="mt-1 text-sm text-danger invalid-feedback" data-field="mobile"></span>
                        </div>
                        ...
                        <div class="input-group password-input-wrapper">
                            <div class="relative">
                                ...
                                <input type="password" name="password"
                                    class="password-input  password-strength-input" id="registerPasswordInput"
                                    placeholder="{{ __('app/auth_modal.password_placeholder', [], $currentLocale) }}"
                                    required
                                    aria-label="{{ __('app/auth_modal.password_placeholder', [], $currentLocale) }}">
                                <button type="button" class="password-toggle-btn"
                                    data-input-id="registerPasswordInput" aria-label="Toggle password visibility">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                            {{-- مؤشر القوة (لا يحتاج إلى تعديل) --}}
                        ...
                        <div class="input-group password-input-wrapper" style="margin-top: 22px;">
                            <div class="relative">
                                <i class="fas fa-lock icon"></i>
                                <input type="password" name="password_confirmation"
                                    class="password-input" id="registerConfirmPasswordInput"
                                ...
                                <button type="button" class="password-toggle-btn"
                                    data-input-id="registerConfirmPasswordInput"
                                    aria-label="Toggle password visibility">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                            ...
                            <span class="mt-1 text-sm text-danger invalid-feedback"
                                data-field="password_confirmation"></span> --}}
                        </div>
                            ...
                            <div class="relative">
                                ...
                                <label for="agreeTerms" id="agreeTermsLabel" style="width: 100%;">
                                    ...
                                    <a href="{{ route('terms-of-use') }}"
                                        target="_blank">{{ __('app/auth_modal.terms_of_use_link_text', [], $currentLocale) }}</a>
                                </label>
                            </div>
                            <span class="mt-1 text-sm text-danger invalid-feedback" data-field="agreeTerms"
        ...
        <div class="auth-dialog-image-side"></div>
    </div>
</div>

...
function setupEditForm() {
    const editForm = document.getElementById('editOrientationForm');
    if (!editForm) return;

    const saveBtn = document.getElementById('updateOrientationBtn');
    ...
    editForm.addEventListener('submit', async function (event) {
        ...
        try {
            ...
            await api.post(getRoute('api.orientation.update'), payload);

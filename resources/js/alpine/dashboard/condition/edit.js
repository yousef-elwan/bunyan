...
function setupEditForm() {
    const editForm = document.getElementById('editConditionForm');
    if (!editForm) return;

    const saveBtn = document.getElementById('updateConditionBtn');
    ...
    editForm.addEventListener('submit', async function (event) {
        ...
        try {
            ...
            await api.post(getRoute('api.condition.update'), payload);
